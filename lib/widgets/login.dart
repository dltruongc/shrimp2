...
//     _loginBloc.disposeLogin();
//     super.dispose();
//   }

//   @override
//   void initState() {
//     _loginBloc = SettingBloc();
//     super.initState();
//   }
...
//     return MyApp.of(context).loginAccount['id'] != null
//         ? _loggedIn()
//         :
//         // Padding(
...
//                         child: InkWell(
//                           onTap: () {
//                             var isValid = _loginBloc.loginValid(
...
//                                       _emailInput.text, _passWordInput.text)
//                                   .then((data) {
//                                 MyApp.of(context).setLoginAccount(
//                                   data['accountId'],
