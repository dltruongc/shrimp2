...
class ShrimSizeBloc extends BaseBloc with ChangeNotifier {
  ...
  void dispatch(BaseEvent event) async {
    ...
    if(event is ShrimSizeEvent) if(event.shrimpSizeEnum == ShrimSizeEnum.getAllData){
      _listShrimpSize.isNotEmpty ?? _listShrimpSize.removeLast();
    } else{}
  }
